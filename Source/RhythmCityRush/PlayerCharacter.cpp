...
APlayerCharacter::APlayerCharacter()
{
	...
	CameraBoom->SetupAttachment(RootComponent); // ToDo: Add a socket for attachment under Character's shoulders.
	CameraBoom->TargetArmLength = 650.0f; // Distance the camera follows behind the player.
